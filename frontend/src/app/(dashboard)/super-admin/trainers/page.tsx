        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {loading ? (
            ...
            filteredTrainers.map((t) => (
              <div
                key={t.id}
                className="rounded-2xl bg-slate-900/60 border border-slate-800 p-5 backdrop-blur-xl hover:border-blue-500/40 transition duration-300 flex flex-col justify-between shadow-lg"
              >
                <div>
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-indigo-600/30 to-blue-600/30 border border-indigo-500/30 flex items-center justify-center text-white font-extrabold text-base">
                      {t.first_name[0]}
                      {t.last_name[0]}
                    </div>
